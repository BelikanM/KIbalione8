...
# Import des agents LangChain avec gestion robuste
AgentExecutor = None
create_react_agent = None
try:
    from langchain.agents import AgentExecutor, create_react_agent
    print("✅ Agents LangChain importés avec succès")
except ImportError:
    try:
        from langchain_community.agents import AgentExecutor, create_react_agent
        print("✅ Agents LangChain Community importés avec succès")
    except ImportError:
        try:
            from langchain.agents import AgentExecutor
            from langchain.agents.react.agent import create_react_agent
            print("✅ Agents LangChain (ancienne version) importés")
        except ImportError:
            print("⚠️ Agents LangChain non disponibles - Mode simplifié")
...
Thought: {agent_scratchpad}""")
    ...
    if create_react_agent is None or AgentExecutor is None:
        st.warning("⚠️ Agents LangChain non disponibles - Mode simplifié activé")
        return None
