...
# Import conditionnel pour éviter les erreurs de version LangChain
AgentExecutor = None
...
try:
    ...
    try:
        ...
        print("⚠️ Agents LangChain non disponibles - fonctionnalités limitées")
...
def get_embedding_model():
    ...
    device = 'cuda' if torch.cuda.is_available() else 'cpu'
    # Utiliser un modèle plus léger et optimisé
    return HuggingFaceEmbeddings(
        ...
        encode_kwargs={
            'batch_size': 8,  # Batch plus petit pour réduire charge CPU
            'show_progress_bar': False,  # Désactiver barre de progression
